...
public class Lab7Part2Tester {
	...
	public static String reverseString(String str) throws StackEmptyException {
		String result = "";
	 ...
	 */
	public static boolean doBracketsMatch(String str) throws StackEmptyException {
	...
	try{
		...
		displayResults(resultString.equals(expected), "reverse empty String");}
			...
			displayResults(true, "exception thrown when it should be " +e);
		}
	...
	try{
		...
		displayResults(false, "exception thrown when it shouldn't be " +e);
	}
