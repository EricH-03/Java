...
public class Lab7Part3Tester {
    ...
    public static void testQueue() throws QueueEmptyException {
      ...
      try{
            q.dequeue();
            displayResults(false, "deque with emtpy stack, should have thrown");
        }

        catch(QueueEmptyException e){
          displayResults(true, "deque with emtpy stack, thrown correctly");
        }
