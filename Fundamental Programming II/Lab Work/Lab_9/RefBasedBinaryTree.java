...
public class RefBasedBinaryTree implements BinaryTree {
    ...
    public int sum(TreeNode t){
     ...
     int sum = t.getValue() + sum(t.right) + sum(t.left);
     return sum;
    ...
    private int getMax(TreeNode t, int max) throws TreeEmptyException {
        ...
        return  Math.max(getMax(t.getLeft(), max), getMax(t.getRight(), max));
    ...
    public static void main(String[] args) {
        ...
        System.out.println(myTree.find(9) + " Should be false");
        try{
        ...
        try{
            System.out.println(emptyTree.getMax() + " should be 7");}
            catch(TreeEmptyException e){
                System.out.println("Caught tree empty exception correctly");
            }
