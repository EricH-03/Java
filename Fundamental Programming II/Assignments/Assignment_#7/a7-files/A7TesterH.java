...
public class A7TesterH {
	...
	public static void testInsertionAndRemoval() {
		...
		result = ((Integer)pq.removeMin()).intValue();
		displayResults(result == 2, "insert + remove on multiple element PQ");
		displayResults(pq.size() == 4, "insert + remove + size on multiple element PQ");

		result = ((Integer)pq.removeMin()).intValue();
		displayResults(result == 3, "insert + remove on multiple element PQ");
		displayResults(pq.size() == 3, "insert + remove + size on multiple element PQ");

		result = ((Integer)pq.removeMin()).intValue();
		displayResults(result == 4, "insert + remove on multiple element PQ");
		displayResults(pq.size() == 2, "insert + remove + size on multiple element PQ");

		result = ((Integer)pq.removeMin()).intValue();
		displayResults(result == 5, "insert + remove on multiple element PQ");
		displayResults(pq.size() == 1, "insert + remove on multiple element PQ");

		result = ((Integer)pq.removeMin()).intValue();
		displayResults(result == 6, "insert + remove on 1 element PQ");
		displayResults(pq.isEmpty(), "insert + remove + size on 1 element PQ");
	}
	...
	public static void testDuplicates() {
		...
		pq.insert(5);
		pq.insert(0);
		//System.out.println("pq after insert 4 1 1 5 0:" + pq);
		result = ((Integer)pq.removeMin()).intValue();
	...
	public static boolean testRandomArray (int count)
	{
		...
		*/
		...
		while (!q.isEmpty()) {
			...
			if (val < oldVal ) {
				System.out.println("fails at: " + i + ": val: " + val + ": oldVal: " + oldVal);
				return false;
			}
			oldVal = val;
			i++;
	...
	public static void testAttendee() {
		...
		Attendee a5 = new Attendee("Mia", t1e, new Time(6,15));
		...
		displayResults(a3.compareTo(a1) > 0, "testing attendee compareTo (ticketType)");

		displayResults(a1.compareTo(a4) < 0, "testing attendee compareTo (ticketType)");
		displayResults(a4.compareTo(a1) > 0, "testing attendee compareTo (ticketType)");
		...
		displayResults(a2.compareTo(a4) < 0, "testing attendee compareTo (ticketType)");
		displayResults(a4.compareTo(a2) > 0, "testing attendee compareTo (ticketType)");

		displayResults(a2.compareTo(a5) > 0, "testing attendee compareTo (ticketType)");
		displayResults(a5.compareTo(a2) < 0, "testing attendee compareTo (ticketType)");

		displayResults(a3.compareTo(a4) < 0, "testing attendee compareTo (ticketType)");
		displayResults(a4.compareTo(a3) > 0, "testing attendee compareTo (ticketType)");

		displayResults(a3.compareTo(a5) > 0, "testing attendee compareTo (ticketType)");
		displayResults(a5.compareTo(a3) < 0, "testing attendee compareTo (ticketType)");

		displayResults(a4.compareTo(a5) > 0, "testing attendee compareTo (ticketType)");
		displayResults(a5.compareTo(a4) < 0, "testing attendee compareTo (ticketType)");

		displayResults(a1.compareTo(a1) == 0, "testing attendee compareTo (ticketType and arrivalTime tiebreaker)");
		displayResults(a2.compareTo(a2) == 0, "testing attendee compareTo (ticketType and arrivalTime tiebreaker)");
		displayResults(a3.compareTo(a3) == 0, "testing attendee compareTo (ticketType and arrivalTime tiebreaker)");
		displayResults(a4.compareTo(a4) == 0, "testing attendee compareTo (ticketType and arrivalTime tiebreaker)");
		displayResults(a5.compareTo(a5) == 0, "testing attendee compareTo (ticketType and arrivalTime tiebreaker)");
