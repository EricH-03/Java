public class A2Tester {
	...
	public static void testAverageGrade() {
		...
		Student s3b = new Student("v00998877", 74);
		Student s4 = new Student("v00224466", 92);
		Student s5 = new Student("v00224468", 75);
		Student s6 = new Student("v00224469", 30);
		Student s7 = new Student("v00224470", 81);
		
		Student[] arr0 = new Student[0];
		Student[] arr1 = {s1, s2, s3a};
		Student[] arr2 = {s3b, s4};
		Student[] arr3 = {s1,s2,s3a,s3b,s4};
		Student[] arr4 = {s5,s6,s7};
		Student[] arr5 = {s1,s2,s3a,s3b,s4,s5,s6,s7};
		
		UvicCourse empty = new UvicCourse("test course", arr0);
		UvicCourse csc110 = new UvicCourse("CSC 110", arr1);
		UvicCourse math100 = new UvicCourse("MATH 100", arr2);
		UvicCourse MyClass = new UvicCourse("Test Case 1", arr3);
		UvicCourse MyClass1 = new UvicCourse("Test Case 2", arr4);
		UvicCourse MyClass2 = new UvicCourse("Test Case 3", arr5);
		...
		result = MyClass.averageGrade();
		expected = 77.6;//77.6
		//System.out.println(result); // for debugging
		displayResults(Math.abs(result-expected)<THRESHOLD, "average grade for MyClass");

		result = MyClass1.averageGrade();
		expected = 62.0;//77.6
		//System.out.println(result); // for debugging
		displayResults(Math.abs(result-expected)<THRESHOLD, "average grade for MyClass1");

		result = MyClass2.averageGrade();
		expected = 71.75;//77.6
		//System.out.println(result); // for debugging
		displayResults(Math.abs(result-expected)<THRESHOLD, "average grade for MyClass1");
