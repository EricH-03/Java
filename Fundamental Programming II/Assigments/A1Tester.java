...
public class A1Tester {
	...
	public static void testGreatestCommonDenominator() {
		...
		System.out.println("Testing GreatestCommonDenominator(11,22)");
		result = A1Exercises.greatestCommonDenominator(11, 22);
		expected = 11;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		
		System.out.println("Testing GreatestCommonDenominator(101,14)");
		result = A1Exercises.greatestCommonDenominator(101, 14);
		expected = 1;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		
		System.out.println("Testing GreatestCommonDenominator(24,4)");
		result = A1Exercises.greatestCommonDenominator(24, 4);
		expected = 4;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		
		System.out.println("Testing GreatestCommonDenominator(10000,250)");
		result = A1Exercises.greatestCommonDenominator(10000,250);
		expected = 250;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		
		System.out.println("Testing GreatestCommonDenominator(6,15)");
		result = A1Exercises.greatestCommonDenominator(6,15);
		expected = 3;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		
		System.out.println("Testing GreatestCommonDenominator(1725,9384)");
		result = A1Exercises.greatestCommonDenominator(1725,9384);
		expected = 69;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
	...
	System.out.println("Testing contains with an empty array");
		result = A1Exercises.countMatches(arr0, 2);
		expected = 0;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
		...
		System.out.println("Testing contains(arr1, 4)");
		result = A1Exercises.countMatches(arr1, 4);
		expected = 0;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
